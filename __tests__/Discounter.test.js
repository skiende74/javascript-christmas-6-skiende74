...
describe('할인', () => {
  ...
  test.each([
    ...
    // when
    const discount = new Discounter(date).getDiscounts().weekday;
    // then
    expect(discount).toBe(expectedDiscount);
  });
  ...
  test.each([
    ...
    // when
    const discount = new Discounter(date).getDiscounts().weekend;
    // then
    expect(discount).toBe(expectedDiscount);
  });
  ...
  test.each([
    ...
    // when
    const discount = new Discounter(date).getDiscounts().special;
    // then
    expect(discount).toBe(expectedDiscount);
  });
});
